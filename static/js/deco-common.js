...
function search_click(){
    var type = $('#jsSelectOption').attr('data-value'),  //获取属性（book或者movie）
        keywords = $('#search_keywords').val(),    //键盘值
        request_url = '';
    if(keywords == ""){
        return
    }
    if(type == "movie"){
        request_url = "/movie/movie_list?keywords="+keywords
    }else if(type == "book"){
        request_url = "/book/book_list?keywords="+keywords
    }
